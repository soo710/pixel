...
1. 공격(적진) :  [공격조 : 파티명 / 린디조], [공격조 : 파티명 / 골드조], [공격조 : 파티명 / 재야조], [공격조 : 파티명 / 려늬조], [공격조 : 파티명 / 자활조]
2. 방어(본진) :  [지원조 : 파티명 / 블리조], [지원조 : 파티명 / 요시조], [지원조 : 파티명 / 댄디조], [방어조 : 파티명 / 루나조], [방어조 : 파티명 / 땜스조]

### 공격팀

1. 시작 후 왼쪽 타워(지도1)-> 오른쪽 타워(지도2) -> 성문(지도3) 순으로 파괴
2. [린디조], [편빈조] -> 적 PK 치중하여 플레이
3. [재야조], [려늬조], [자활조] -> 좌측 방어타워 공격 후 우측 방어타워 공격에 집중
...
3. 1차 방어라인 무너지면 포탑깨질 때까지 넓은지역에서 방어
...
3. 중앙 입구 바리게이트 설치완료후 [슈리유리] 바리게이트 들고 바리게이트조와 함께 버프타워 상단입구에 바리게이트 설치 후 중앙으로 복귀
