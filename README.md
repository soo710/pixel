...
### [파티 편성(링크)](https://docs.google.com/spreadsheets/d/1zlqK4zo03V_a8Ch3rXcRDdcK978dTbnRfcQ9FWhl8Z0/edit#gid=0)

## [ **참여해주세요** ] \*\*

### [디스코드(링크)](https://discord.gg/fzzyCyF4AD)
...
> 킹덤마스터 : **려늬**
>
> 킹덤부마스터 : **골드YH** **l요시l** **쿠키루나**
>
> 킹덤운영진 : **댄디형** **재야의코인** **넘빠르다** **리오리아** **꿍호**

```
  Pixel 킹덤은 남녀노소 함께 어우러지는 성인킹덤입니다.
...
- 킹덤 기부 : 필수
  ...
  _3가지 재화 풀기부_<br />
  _미기부시 1회 경고, 2회이상 다이야기부, 3회이상 제명_<br />

- 킹덤 내 외로 분란을 일으키는 행동(막피 / 비매너 채팅) 3회 : 제명

- 월드창 분란일으키는 행위 (자잘못 떠나서 분란이 일날시 ) 1회 : 제명
...
- 겹사관련 : 귓속말 / 지역채팅으로 대화가 가능하지않은 유저 - 증거 확보 후 PK 가능<br />
  _킹덤단위 대응 아닐 시 개인선에서 해결_       
  _우리 킹덤원의 겹사로 연락 왔을시 멘션 후 5분 이상 연락 안될시 상대에 Pk요청_ 
  _증거 : 앞뒤 정황을 알수있는 사진이나 동영상 등_
 
## [ **행운상점 입찰규칙** ]

- 공지방 사다리타기 진행 후 당첨자만 입찰
- 딩고 / 흑마법결정 / 왕쟁 스킬북 / 리버설찬스 / 유물 스킬북 --> 사다리타기( 오전 7시 미입찰 건, 당첨자 단톡 멘션 후 자율 입찰 ) 
...
1. 공격(적진) :  [공격조 : 파티명 / 1파티], [공격조 : 파티명 / 2파티], [공격조 : 파티명 / 5파티], [공격조 : 파티명 / 6파티], [공격조 : 파티명 / 7파티]
2. 방어(본진) :  [지원조 : 파티명 / 3파티], [지원조 : 파티명 / 4파티], [방어조 : 파티명 / 8파티], [방어조 : 파티명 / 9파티], [방어조 : 파티명 / 10파티]

### 공격팀

1. 시작 후 왼쪽 타워(지도1)-> 오른쪽 타워(지도2) -> 성문(지도3) 순으로 파괴
2. [1파티], [2파티] -> 적 PK 치중하여 플레이
3. [5파티], [6파티], [7파티] -> 좌측 방어타워 공격 후 우측 방어타워 공격에 집중
4. 각인 1 이후 방어팀 상황보고 Pixel 킹덤영지로 이동 후 전체 방어에 집중
...
1. 시작과 동시 바이게이트 들고 [1파티], [2파티] 엄호 받으며 파티원 5명 모두 바리게이트 들고 중앙이동 후 바리게이트 설치
2. [파티원1],[파티원2],[파티원3] ->중앙 입구 바리게이트 설치 / [파티원4] [파티원5]는 중앙에 바리게이트 두고 함께 이동
3. 중앙 입구 바리게이트 설치완료후 [파티원4] 바리게이트 들고 바리게이트조와 함께 버프타워 상단입구에 바리게이트 설치 후 중앙으로 복귀
4. 중앙에 남은 바리게이트 [파티원5]가 들고 바리게이트조와 함께 버프타워 상단입구에 바리게이트 설치 후 중앙으로 복귀 후 중앙 사수
(바리게이트 타 파티에서 들지 않도록 주의 부탁드립니다.)

### [지원조 : 파티명 / 4파티]

1. 시작과 동시 후냐인형 들고 [파티원1],[파티원2],[파티원3] 중앙으로 이동 후 중앙에 후냐 설치
2. 시작과 동시 [파티원4] 1번으로 이동하여 후냐 설치 후 중앙으로 이동 중앙사수
3. 시작과 동시 [파티원5] 3번으로 이동하여 후냐 설치 후 중앙으로 이동 중앙사수

### [공격조 : 파티명 / 5파티], [공격조 : 파티명 / 6파티], [공격조 : 파티명 / 7파티], [방어조 : 파티명 / 8파티], [방어조 : 파티명 / 9파티], [방어조 : 파티명 / 10파티]
